    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          ...
          >
            <ArrowLeftIcon className="h-5 w-5 mr-2" />
            <span>Kembali ke Tim website</span>
          </Link>
              ...
              <div className="p-8 md:w-2/3">
                ...
                <div className="bg-blue-50 rounded-lg p-6">
                  ...
                  <Typography className="text-gray-700">
                    {member.attributes.Nama_Anggota} adalah anggota tim website yang berdedikasi dan penuh talenta. 
                  ...
                  return (
                    <Card key={otherMember.id} className="overflow-hidden shadow-lg hover:shadow-xl transition-shadow">
                      ...
                      <CardBody className="p-4">
                        ...
                        <Link
                          href={`/divisi/website/${otherMember.attributes.seoURL || otherMember.id}`}

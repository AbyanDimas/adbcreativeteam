      ...
      <div className="container mx-auto">
        <div className="mb-12 text-center">
          ...
          <Typography variant="lead" className="text-gray-600">
            Kenali anggota tim website kami yang kreatif dan penuh talenta
          </Typography>
        </div>
        ...
        {members.length === 0 ? (
          <div className="text-center py-12">
            ...
            <Typography className="text-gray-500">
              Saat ini tidak ada anggota di divisi website
            </Typography>
          </div>
        ) : viewMode === "list" ? (
              ...
              <Card key={member.id} color="transparent" shadow={false} className="border">
                <CardBody className="grid grid-cols-1 lg:grid-cols-4 gap-8">
                  ...
                  <div className="col-span-3 w-full">
                    ...
                    <div className="mt-8">
                      <a
                        href={`/divisi/website/${member.attributes.seoURL || member.id}`}
